 ...
 */
@WebServlet("/GetPreventivesManagedByEmployee")
public class GetPreventivesManagedByEmployee extends HttpServlet {
     ...
     */
    public GetPreventivesManagedByEmployee() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			response.getWriter().println("It was not possible to get the preventives managed by the employee");
			return;
		}
